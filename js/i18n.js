...
const TRANSLATIONS = {
  it: {
    ...
    consoleErrorRequireList: "⚠️ Errore: Per risolvere questo livello, devi definire e utilizzare una lista ('[ ]')!",
    consoleErrorRequireRecursion: "⚠️ Errore: Per risolvere questo livello, la tua funzione deve chiamare se stessa ricorsivamente!",
  ...
  en: {
    ...
    consoleErrorRequireList: "⚠️ Error: To solve this level, you must define and use a list ('[ ]')!",
    consoleErrorRequireRecursion: "⚠️ Error: To solve this level, your function must call itself recursively!",
