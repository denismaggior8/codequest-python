const ROOM_FUNCTIONS_1 = {
  ...
  docs: {
    it: [
      ...
      { code: "hero.collect_ruby()", desc: "Raccogli il rubino." },
      { code: "hero.turn_left() / turn_right()", desc: "Gira Knil a sinistra o destra." },
    ...
    en: [
      ...
      { code: "hero.collect_ruby()", desc: "Collect the ruby." },
